...
def main(emotiv_controller):

    emotiv_controller.establish_connection()
    ...
    while True:
        ...
        while True:
            movementInfo = showWelcomeAnimation(emotiv_controller)
            crashInfo = mainGame(movementInfo, emotiv_controller)
            #showGameOverScreen(crashInfo, emotiv_controller)


def showWelcomeAnimation(emotiv_controller):
...
def mainGame(movementInfo, emotiv_controller):
...
def showGameOverScreen(crashInfo, emotiv_controller):
